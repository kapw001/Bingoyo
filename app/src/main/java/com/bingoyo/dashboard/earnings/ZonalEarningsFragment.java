 ...
 */
public class ZonalEarningsFragment extends EarningBaseFragment {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (getView() != null) {
            if (viewChangeCallBack != null) viewChangeCallBack.onZonalCallBack();
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_zonal_earnings, container, false);
